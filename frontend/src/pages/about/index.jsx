...
const AboutUs = () => {
  return (
    <div className="bg-[#FCFAF7] min-h-screen font-sans">
      ...
      >
        <div className="absolute inset-0 bg-[#8C5A3C]/35"></div>
      ...
      <section className="py-16 px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {[
            ...
            >
              <div className="text-6xl w-20 h-20 p-5 rounded-full bg-[#EAD8C8] text-[#8C5A3C] mb-6 shadow-[0_-5px_20px_rgba(140,90,60,0.18)] flex justify-center items-center">
                {item.icon}
              </div>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <button className="mt-8 bg-[#8C5A3C] hover:bg-[#74482F] text-white font-semibold px-6 py-3 rounded-full shadow-md transition">
            Discover More
          </button>
        </div>
      </section>
