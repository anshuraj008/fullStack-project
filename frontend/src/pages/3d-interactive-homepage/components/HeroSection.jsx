        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-5rem)]">
          ...
          <motion.div className="relative" variants={itemVariants}>
            ...
            >
              ...
              {/* Floating icons */}
              <motion.div
                className="absolute -top-4 -right-4 w-8 h-8 bg-[#A66A49] rounded-full flex items-center justify-center shadow-medium"
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-4xl mx-auto">
          ...
          >
            <Link
              ...
              className="flex flex-col items-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
                <div className="w-12 h-12 bg-[#A66A49] rounded-full flex items-center justify-center mb-4 group-hover:bg-[#8C5A3C] transition-colors">
          ...
          >
            <Link
              ...
              className="flex flex-col items-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
                <div className="w-12 h-12 bg-[#B77A52] rounded-full flex items-center justify-center mb-4 group-hover:bg-[#8C5A3C] transition-colors">
